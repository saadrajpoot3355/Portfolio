...
const socials = [
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/roboticswithsaad',
    icon: InstagramIcon,
  },
  {
    label: 'TikTok',
    href: 'https://www.tiktok.com/@roboticswithsaad',
    icon: TikTokIcon,
  },
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/roboticswithsaad',
    icon: FacebookIcon,
  },
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@robotics-with-saad',
    icon: YouTubeIcon,
  },
];
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            {socials.map(({ label, href, icon: Icon }) => (
              <a
                ...
                title={label}
                className="inline-flex items-center gap-1.5 rounded-full border border-white/15 px-3 py-1.5 text-[11px] sm:text-xs font-semibold text-slate-300 transition-all hover:bg-white/10 hover:text-white hover:border-white/30 active:scale-[0.97]"
              >
